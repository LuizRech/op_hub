...
/* themes/ajans/templates/content/links--node.html.twig */
class __TwigTemplate_e3c56094de4e737813ea85eb2ba5872c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["links"] ?? null)) {
            ...
            // line 45
            $context["classes"] = ["uk-subnav", "uk-subnav-pill"];
            // line 50
            yield "  <ul";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 52
                yield "<li";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 52), 52, $this->source), "html", null, true);
                yield ">";
                // line 53
                if (CoreExtension::getAttribute($this->env, $this->source, $context["item"], "link", [], "any", false, false, true, 53)) {
                    // line 54
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "link", [], "any", false, false, true, 54), 54, $this->source), "html", null, true);
                } elseif (CoreExtension::getAttribute($this->env, $this->source,                 // line 55
$context["item"], "text_attributes", [], "any", false, false, true, 55)) {
                    // line 56
                    yield "<span";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "text_attributes", [], "any", false, false, true, 56), 56, $this->source), "html", null, true);
                    yield ">";
                    ...
                    // line 58
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "text", [], "any", false, false, true, 58), 58, $this->source), "html", null, true);
                }
                // line 60
                yield "</li>";
            }
    ...
    {
        return "themes/ajans/templates/content/links--node.html.twig";
    }
    ...
    {
        return array (  100 => 62,  94 => 60,  91 => 58,  84 => 56,  82 => 55,  80 => 54,  78 => 53,  74 => 52,  70 => 51,  66 => 50,  64 => 45,  56 => 41,  46 => 39,  44 => 38,  42 => 37,  40 => 36,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/ajans/templates/content/links--node.html.twig", "/var/www/html/web/themes/ajans/templates/content/links--node.html.twig");
    }
